  ...
  return (
    <nav className="bg-orange-500 text-white shadow-md">
      <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
        <h1 className="text-2xl font-bold">Cristine's Kitchen</h1>

        {/* Desktop Menu */}
        <ul className="hidden md:flex gap-6">
          <li><Link to="/" className="hover:text-orange-200">Home</Link></li>
          <li><Link to="/favorites" className="hover:text-orange-200">Favorites</Link></li>
          <li><Link to="/about" className="hover:text-orange-200">About</Link></li>
        </ul>
